...
namespace MultiplayerARPG.MMO
{
    ...
    public sealed partial class MapNetworkManager : BaseGameNetworkManager, IAppServer
    {
        ...
        protected override void Start()
        {
	        ...
	        // Tournament
	        ClusterClient.RegisterMessageHandler(MMOMessageTypes.TournamentFinish, HandleTournamentFinish);
	        ClusterClient.RegisterMessageHandler(MMOMessageTypes.TournamentReset, HandleTournamentReset);
	        // Tournament

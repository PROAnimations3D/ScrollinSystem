...
namespace MultiplayerARPG
{
    public enum UITextKeys : ushort
    {
	   ...
	   //Dungeon
	   UI_ERROR_NOT_ENOUGH_TRIAL_DUNGEON,
	   UI_ERROR_NOT_START_EVENT_DUNGEON,
	   UI_ERROR_NOT_SAME_PARTY_MAP_DUNGEON,
	   UI_ERROR_NOT_ENOUGH_PARTY_MEMBER_LEVEL_DUNGEON,
	    // Tournament
	    UI_SUCCES_PLACE_TOURNAMENT,
	    UI_SUCCES_RESET_TOURNAMENT,
	    UI_SUCCES_FINISH_TOURNAMENT,
	    UI_SUCCES_REGISTER_TOURNAMENT,
	    UI_ERROR_NOT_START_TOURNAMENT,
	// Tournament
    }
